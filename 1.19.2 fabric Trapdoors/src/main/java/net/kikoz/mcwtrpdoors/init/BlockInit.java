...
public class BlockInit {
    ...
    public static final Block MANGROVE_BEACH_TRAPDOOR = registerBlock("mangrove_beach_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block MANGROVE_COTTAGE_TRAPDOOR = registerBlock("mangrove_cottage_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block MANGROVE_FOUR_PANEL_TRAPDOOR = registerBlock("mangrove_four_panel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block MANGROVE_GLASS_TRAPDOOR = registerBlock("mangrove_glass_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block MANGROVE_MYSTIC_TRAPDOOR = registerBlock("mangrove_mystic_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    ...
    public static final Block MANGROVE_BARK_TRAPDOOR = registerBlock("mangrove_bark_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    ...
    public static final Block MANGROVE_RANCH_TRAPDOOR = registerBlock("mangrove_ranch_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);

    public static final Block BAMBOO_TRAPDOOR = registerBlock("bamboo_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.GREEN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
