...
public class BlockInit {
    ...
    public static final Block OAK_BLOSSOM_TRAPDOOR = registerBlock("oak_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block SPRUCE_BLOSSOM_TRAPDOOR = registerBlock("spruce_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block BIRCH_BLOSSOM_TRAPDOOR = registerBlock("birch_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block JUNGLE_BLOSSOM_TRAPDOOR = registerBlock("jungle_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block ACACIA_BLOSSOM_TRAPDOOR = registerBlock("acacia_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block DARK_OAK_BLOSSOM_TRAPDOOR = registerBlock("dark_oak_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block WARPED_BLOSSOM_TRAPDOOR = registerBlock("warped_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block CRIMSON_BLOSSOM_TRAPDOOR = registerBlock("crimson_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block BAMBOO_BLOSSOM_TRAPDOOR = registerBlock("bamboo_blossom_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD).strength(1.8F).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);

    //1.1.2
    public static final Block OAK_BARREL_TRAPDOOR = registerBlock("oak_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block SPRUCE_BARREL_TRAPDOOR = registerBlock("spruce_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block BIRCH_BARREL_TRAPDOOR = registerBlock("birch_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block JUNGLE_BARREL_TRAPDOOR = registerBlock("jungle_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block ACACIA_BARREL_TRAPDOOR = registerBlock("acacia_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block DARK_OAK_BARREL_TRAPDOOR = registerBlock("dark_oak_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block WARPED_BARREL_TRAPDOOR = registerBlock("warped_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block CRIMSON_BARREL_TRAPDOOR = registerBlock("crimson_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
    public static final Block BAMBOO_BARREL_TRAPDOOR = registerBlock("bamboo_barrel_trapdoor", new Trapdoor(FabricBlockSettings.of(Material.WOOD, MapColor.OAK_TAN).strength(1.5F, 2.5F).sounds(BlockSoundGroup.WOOD).nonOpaque()), TrapdoorGroup.TRAPDOORSGROUP);
