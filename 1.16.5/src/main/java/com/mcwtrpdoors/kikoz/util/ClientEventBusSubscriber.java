...
public class ClientEventBusSubscriber {
	...
	public static void clientSetup(FMLClientSetupEvent event) {
		...
		RenderTypeLookup.setRenderLayer(BlockInit.OAK_BARN_TRAPDOOR.get(), RenderType.translucent());
		...
		RenderTypeLookup.setRenderLayer(BlockInit.OAK_GLASS_TRAPDOOR.get(), RenderType.translucent());
		...
		RenderTypeLookup.setRenderLayer(BlockInit.SPRUCE_GLASS_TRAPDOOR.get(), RenderType.cutoutMipped());
