...
public class ItemInit {
	...
	public static final RegistryObject<Item> CHERRY_BARN_TRAPDOOR = ITEMS.register("cherry_barn_trapdoor", () -> new BlockItem(BlockInit.CHERRY_BARN_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_BARRED_TRAPDOOR = ITEMS.register("cherry_barred_trapdoor", () -> new BlockItem(BlockInit.CHERRY_BARRED_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_BEACH_TRAPDOOR = ITEMS.register("cherry_beach_trapdoor", () -> new BlockItem(BlockInit.CHERRY_BEACH_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_CLASSIC_TRAPDOOR = ITEMS.register("cherry_classic_trapdoor", () -> new BlockItem(BlockInit.CHERRY_CLASSIC_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_COTTAGE_TRAPDOOR = ITEMS.register("cherry_cottage_trapdoor", () -> new BlockItem(BlockInit.CHERRY_COTTAGE_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_FOUR_PANEL_TRAPDOOR = ITEMS.register("cherry_four_panel_trapdoor", () -> new BlockItem(BlockInit.CHERRY_FOUR_PANEL_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_GLASS_TRAPDOOR = ITEMS.register("cherry_glass_trapdoor", () -> new BlockItem(BlockInit.CHERRY_GLASS_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_PAPER_TRAPDOOR = ITEMS.register("cherry_paper_trapdoor", () -> new BlockItem(BlockInit.CHERRY_PAPER_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_TROPICAL_TRAPDOOR = ITEMS.register("cherry_tropical_trapdoor", () -> new BlockItem(BlockInit.CHERRY_TROPICAL_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_MYSTIC_TRAPDOOR = ITEMS.register("cherry_mystic_trapdoor", () -> new BlockItem(BlockInit.CHERRY_MYSTIC_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_BAMBOO_TRAPDOOR = ITEMS.register("cherry_bamboo_trapdoor", () -> new BlockItem(BlockInit.CHERRY_BAMBOO_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_SWAMP_TRAPDOOR = ITEMS.register("cherry_swamp_trapdoor", () -> new BlockItem(BlockInit.CHERRY_SWAMP_TRAPDOOR.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHERRY_RANCH_TRAPDOOR = ITEMS.register("cherry_ranch_trapdoor", () -> new BlockItem(BlockInit.CHERRY_RANCH_TRAPDOOR.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CHERRY_BARK_TRAPDOOR = ITEMS.register("cherry_bark_trapdoor", () -> new BlockItem(BlockInit.CHERRY_BARK_TRAPDOOR.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CHERRY_BARREL_TRAPDOOR = ITEMS.register("cherry_barrel_trapdoor", () -> new BlockItem(BlockInit.CHERRY_BARREL_TRAPDOOR.get(), new Item.Properties()));
